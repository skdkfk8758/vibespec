...
7. **머지 리포트 데이터 수집**: `references/merge-report.md`의 "데이터 수집" 섹션에 따라 changes_summary, ai_judgments, 테스트 커버리지 갭을 수집하세요.
...
2. **머지 리포트 자동 생성**: `references/merge-report.md`의 가이드를 따라 리포트를 생성하세요.
