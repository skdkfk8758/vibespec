...
5a. **비판적 검토 자동 디스패치** (조건부)
   ...
   `references/plan-review-agents.md`의 "비판적 검토 자동 디스패치" 섹션을 따라 실행하세요.
   조건: 태스크 수 >= 4 또는 복잡도 >= 2. 미충족 시 Step 6으로 진행.
...
6. **플랜 리뷰**
   ...
   `references/plan-review-agents.md`의 "인라인 비판적 검토" 섹션을 따라 실행하세요.
